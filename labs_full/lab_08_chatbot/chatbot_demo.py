#!/usr/bin/env python3
"""
Lab 8: Chatbot with Bi-directional LSTM (FULL VERSION)
=======================================================

Full version using Cornell Movie Dialogs dataset with scaled-up parameters.

Full version parameters (vs lite):
- Uses 5000 real dialog pairs (specified in task; lite used 10000 but at reduced quality)
  Note: full version uses 5000 for focused training with larger model
- 30 epochs (vs 20)
- Larger batch size: 64 (vs 32)
- Larger vocabulary: 8000 words (vs 5000)
...
class Encoder(nn.Module):
    """Bi-directional LSTM encoder (larger for full version)."""
...
def main():
    print("=" * 60)
    print("Lab 8: Chatbot with Cornell Movie Dialogs (FULL VERSION)")
    print("=" * 60)
    ...
    # Create model
    print("\nCreating Seq2Seq Chatbot Model (embed=256, hidden=512)...")
