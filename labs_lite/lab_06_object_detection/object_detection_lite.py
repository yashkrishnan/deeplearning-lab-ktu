#!/usr/bin/env python3
"""
Lab 6 Lite: Object Detection with YOLO-style Architecture
==========================================================

Lightweight version using VOC2012 dataset with reduced samples and epochs.

Changes from original:
- Uses 50 real VOC2012 images (local sample dataset)
- 10 epochs (from 30)
- Smaller batch size: 8 (from 16)
- Reduced image size: 224x224
- Simplified model architecture
- Uses 3 common classes: person, car, dog

Dataset: Pascal VOC 2012 (local sample)
Expected runtime: ~15-20 seconds on CPU
...
class VOCDetectionDataset(Dataset):
    ...
    def __init__(self, voc_root, img_size=224, max_samples=None, max_objects=5):
...
class SimplifiedYOLO(nn.Module):
    ...
    def __init__(self, num_classes=3, max_objects=5):
...
def main():
    print("=" * 60)
    print("Lab 6 Lite: Object Detection with VOC2012")
    print("=" * 60)
    ...
    # Load dataset
    print(f"\nLoading VOC2012 dataset (max {NUM_SAMPLES} samples)...")
    ...
    # Create model
    print("\nCreating Simplified YOLO model...")
    model = SimplifiedYOLO(num_classes=NUM_CLASSES, max_objects=MAX_OBJECTS)
    ...
    visualize_detections(model, dataset, device, num_samples=4)
    ...
    print("\nLab 6 Lite completed successfully!")
